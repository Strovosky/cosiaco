...
from .views import CrearUsuarioGenericAPIView, ObtenerUsuarioGenericView, DesactivarUsuarioGenericView, DestruirCosiacoGeneric, CrearCategoriaGeneric, DestruirCategoriaGeneric, CrearEstrellaGeneric, ObtenerCategoriaGeneric, ObtenerCosiacoGeneric, CrearDestruirLikeGenericView, ObtenerTodasCategoriasGeneric, ObtenerUsuarioPerfilAPIView, ObtenerUltimosCosiacos, ObtenerCosiacosUsurioGeneric, ObtenerOpinionCosiaco, ObtenerCosiacosPopulares, ObtenerCosiacoPorNombreGeneric
...
urlpatterns = [
    ...
    path(route="obtener_cosiaco_por_nombre/<str:nombre>/", view=ObtenerCosiacoPorNombreGeneric.as_view(), name="obtener_cosiaco_por_nombre"),
    path(route="obtener_ultimos_cosiacos/", view=ObtenerUltimosCosiacos.as_view(), name="obtener_ultimos_cosiacos"),
    path(route="obtener_cosiacos_usuario_generic/<int:pk>/", view=ObtenerCosiacosUsurioGeneric.as_view(), name="obtener_cosiacos_usuario_generic"),
    path(route="obtener_cosiacos_populares/", view=ObtenerCosiacosPopulares.as_view(), name="obtener_cosiacos_populares"),
